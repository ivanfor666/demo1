...
import { List,Modal,Button,InputItem,Picker,DatePicker,Toast } from 'antd-mobile';
import { createForm } from 'rc-form';
import  '../components/component.less';
const Item = List.Item;
const Brief = Item.Brief;
const fundList = [
  "国泰", "银华","全兴","光大", "上投", "华夏", "中欧", "鹏华","万家", "广发","华安",  "天弘",  "建信", "华宝", "招商", "富国",  "国投", "民生", "嘉实",
]
...
class MyModal extends React.Component{
  ...
  render(){
    ...
    return(
      ...
      >
        <List renderHeader={() => <div>基金买入</div>} className="popup-list">
          <List>
            <Picker
              data={users}
              value={user}
          ...
          <List.Item style={{marginTop:48,marginBottom:24}}>
            <Button type="primary" onClick={this.save}>买入</Button>
          </List.Item>
        </List>
      </Modal>
    )
...
export default connect()(createForm()(MyModal));
